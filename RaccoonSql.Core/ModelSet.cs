    ...
    where TData : IModel
{
    ...
    internal ModelSet(IStorageEngine storageEngine,
    ...
    {
        var storageInfo = _storageEngine.GetStorageInfo(typeof(TData), data.Id);
    ...
    {
        var storageInfo = _storageEngine.GetStorageInfo(typeof(TData), id);
